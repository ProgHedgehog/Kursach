...
namespace MDI_Project
{
    class DataBase
    {
        ...
        public void AddDataBase()
        {
            ...
            SQLiteCommand goods = new SQLiteCommand("create table if not exists Goods(GoodsID INTEGER PRIMARY KEY, ContractorID INTEGER, Name TEXT, Price INTEGER, Amount INTEGER, MinAmount INTEGER, CONSTRAINT Goods_Contractorfk FOREIGN KEY (ContractorID) REFERENCES Contractor(ContractorID))", sql);
